...
| **Trần Hoàng Mai Anh**   | Semantic Chunking tự thiết kế (đại diện chấm: RecursiveChunker) | —                                                                                           | **6 / 10** (tự chấm — xem `REPORT_CANHAN.md`)                             | Đóng chunk theo biến động ngữ nghĩa thay vì ranh giới cố định. | Tự báo cáo: nhồi metadata cấp tài liệu giống nhau vào mọi chunk có thể pha loãng khả năng phân biệt giữa các chunk. |
